...
//
//  it('has detail.', ()=>{
//    find(doc, '[data-s="publicTypedefs"] [data-s="member"]:nth-of-type(1)', (doc)=>{
...
//  });
//
//  find(doc, '[data-s="protectedTypedefs"] [data-s="member"]:nth-of-type(1)', (doc)=>{
//    assert.includes(doc, '#global-typedef2', 'protected typedef2: boolean');
//    assert.includes(doc, '[data-s="description"]', 'this is typedef2 desc.');
//  });
//
//  find(doc, '[data-s="privateTypedefs"] [data-s="member"]:nth-of-type(1)', (doc)=>{
